<template>
  <div>
      ...
      <template slot-scope="scope">
        <div class="fl-left left-mg-xs">
          <el-upload
                  ...
                  name="avatar"
          >
            <img :src="scope.row.avatar_url" :alt="scope.row.alt" height="80" width="80" class="avatar" v-if="scope.row.avatar_url" />
    ...
    <el-table-column label="是否删除" prop="is_deleted" width="120"></el-table-column> 
...
export default {
  ...
  data() {
    return {
      ...
      pkgCategories: [],
      formData: {
        id:null,hospital_id:null,name:null,target:null,disease:null,price_original:null,price_real:null,avatar_url:null,brief:null,comment:null,tips:null,create_time:null,update_time:null,is_deleted:null,
      },
      hospital_idOptions: [{
        "label": "美年大健康",
        "value": 0
